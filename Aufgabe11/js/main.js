...
(function (Aufgabe11) {
    ...
    function init(_event) {
        ...
        for (let i = 0; i < 15; i++) {
            let child = new Aufgabe11.children();
            child.x = Aufgabe11.crc2.canvas.width;
            child.y = Math.random() * Aufgabe11.crc2.canvas.height + 150;
        ...
        for (let i = 0; i < 6; i++) {
            ...
            Aufgabe11.crc2.moveTo(0, Aufgabe11.crc2.canvas.height - 100);
            Aufgabe11.crc2.lineTo(Aufgabe11.crc2.canvas.width, 150);
